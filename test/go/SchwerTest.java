...
public class SchwerTest {
    ...
    /**
     * Test of erzeugePosition method, of class Schwer.
     */
    @Test
    public void testErzeugePosition() {
        ...
        Schwer instance = new Schwer(Zustand.schwarz, new KIVariante(variante));
        ...
        instance = new Schwer(Zustand.schwarz, new KIVariante(variante));
